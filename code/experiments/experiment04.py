...
def plotEvaluationPerformance(
    ...
    if title_plot7 is not []: plt.plot(iterations, training_accuracy_plot7, label=title_plot7+" Focus")
    if title_plot8 is not []: plt.plot(iterations, training_accuracy_plot8, label=title_plot8+" Focus")
    if title_plot9 is not []: plt.plot(iterations, training_accuracy_plot9, label=title_plot9+" Focus")
    if("All" in title_plots):
        ...
        if title_plot7 is not []: plt.errorbar(iterations, training_accuracy_plot7, training_accuracy_plot7_standardDeviation, linestyle='None', marker='^')
        if title_plot8 is not []: plt.errorbar(iterations, training_accuracy_plot8, training_accuracy_plot8_standardDeviation, linestyle='None', marker='^')
        if title_plot9 is not []: plt.errorbar(iterations, training_accuracy_plot9, training_accuracy_plot9_standardDeviation, linestyle='None', marker='^')
    ...
    if title_plot7 is not []: plt.plot(iterations, training_loss_plot7, label=title_plot7+" Focus")
    if title_plot8 is not []: plt.plot(iterations, training_loss_plot8, label=title_plot8+" Focus")
    if title_plot9 is not []: plt.plot(iterations, training_loss_plot9, label=title_plot9+" Focus")
    if("All" in title_plots):
        ...
        if title_plot7 is not []: plt.errorbar(iterations, training_loss_plot7, training_loss_plot7_standardDeviation, linestyle='None', marker='^')
        if title_plot8 is not []: plt.errorbar(iterations, training_loss_plot8, training_loss_plot8_standardDeviation, linestyle='None', marker='^')
        if title_plot9 is not []: plt.errorbar(iterations, training_loss_plot9, training_loss_plot9_standardDeviation, linestyle='None', marker='^')
    plt.axvline(x=0, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=5, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=11, ymin=0., ymax=1., linestyle='dotted')
    ...
    if title_plot7 is not []: plt.plot(iterations, testing_accuracy_plot7, label=title_plot7+" Focus")
    if title_plot8 is not []: plt.plot(iterations, testing_accuracy_plot8, label=title_plot8+" Focus")
    if title_plot9 is not []: plt.plot(iterations, testing_accuracy_plot9, label=title_plot9+" Focus")
    if("All" in title_plots):
        ...
        if title_plot7 is not []: plt.errorbar(iterations, testing_accuracy_plot7, testing_accuracy_plot7_standardDeviation, linestyle='None', marker='^')
        if title_plot8 is not []: plt.errorbar(iterations, testing_accuracy_plot8, testing_accuracy_plot8_standardDeviation, linestyle='None', marker='^')
        if title_plot9 is not []: plt.errorbar(iterations, testing_accuracy_plot9, testing_accuracy_plot9_standardDeviation, linestyle='None', marker='^')
    plt.axvline(x=0, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=5, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=11, ymin=0., ymax=1., linestyle='dotted')
    plt.legend(loc="center right")
    ...
    if title_plot7 is not []: plt.plot(iterations, testing_loss_plot7, label=title_plot7+" Focus")
    if title_plot8 is not []: plt.plot(iterations, testing_loss_plot8, label=title_plot8+" Focus")
    if title_plot9 is not []: plt.plot(iterations, testing_loss_plot9, label=title_plot9+" Focus")
    if("All" in title_plots):
        ...
        if title_plot7 is not []: plt.errorbar(iterations, testing_loss_plot7, testing_loss_plot7_standardDeviation, linestyle='None', marker='^')
        if title_plot8 is not []: plt.errorbar(iterations, testing_loss_plot8, testing_loss_plot8_standardDeviation, linestyle='None', marker='^')
        if title_plot9 is not []: plt.errorbar(iterations, testing_loss_plot9, testing_loss_plot9_standardDeviation, linestyle='None', marker='^')
    plt.axvline(x=0, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=5, ymin=0., ymax=1., linestyle='dotted')
    plt.axvline(x=11, ymin=0., ymax=1., linestyle='dotted')
    plt.legend(loc="upper left")
...
def summarize_KPIs(maxNumberOfExperiments = 10, maxIterationsInPhase1 = 5, maxIterationsInPhase2 = 5, maxMachines = 3, maxValidationSets = 3, maxStreams = 2, maxNumberOfKPIs = 3):
    ...
    training_accuracy_manipulation_mu = (
        numpy.mean(trainingKPIs[:, :, 3, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 13, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 23, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 33, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 41, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 53, :], axis=0)
    ) / 6
    ...
    testing_accuracy_manipulation_mu = (
        numpy.mean(testingKPIs[:, :, 3, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 13, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 23, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 33, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 41, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 53, :], axis=0)
    ) / 6
    ...
    training_accuracy_manipulation_standardDeviation = (
        numpy.std(trainingKPIs[:, :, 3, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 13, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 23, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 33, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 41, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 53, :], axis=0)
    ) / 6
    ...
    testing_accuracy_manipulation_standardDeviation = (
        numpy.std(testingKPIs[:, :, 3, :], axis=0)
        + numpy.std(testingKPIs[:, :, 13, :], axis=0)
        + numpy.std(testingKPIs[:, :, 23, :], axis=0)
        + numpy.std(testingKPIs[:, :, 33, :], axis=0)
        + numpy.std(testingKPIs[:, :, 41, :], axis=0)
        + numpy.std(testingKPIs[:, :, 53, :], axis=0)
    ) / 6
    ...
    training_accuracy_complement_mu = (
        numpy.mean(trainingKPIs[:, :, 4, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 12, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 24, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 32, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 42, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 52, :], axis=0)
    ) / 6
    ...
    testing_accuracy_complement_mu = (
        numpy.mean(testingKPIs[:, :, 4, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 12, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 24, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 32, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 42, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 52, :], axis=0)
    ) / 6
    ...
    training_accuracy_complement_standardDeviation = (
        numpy.std(trainingKPIs[:, :, 4, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 12, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 24, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 32, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 42, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 52, :], axis=0)
    ) / 6
    ...
    testing_accuracy_complement_standardDeviation = (
        numpy.std(testingKPIs[:, :, 4, :], axis=0)
        + numpy.std(testingKPIs[:, :, 12, :], axis=0)
        + numpy.std(testingKPIs[:, :, 24, :], axis=0)
        + numpy.std(testingKPIs[:, :, 32, :], axis=0)
        + numpy.std(testingKPIs[:, :, 42, :], axis=0)
        + numpy.std(testingKPIs[:, :, 52, :], axis=0)
    ) / 6
    ...
    training_loss_baseline_mu = (
        numpy.mean(trainingKPIs[:, :, 1, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 2, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 10, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 11, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 18, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 20, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 27, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 29, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 36, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 37, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 45, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 46, :], axis=0)
    ) / 12
    save_data_to_CsvFile([list(training_loss_baseline_mu)], path + "training_loss_baseline_mu")
    testing_loss_baseline_mu = (
        numpy.mean(testingKPIs[:, :, 1, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 2, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 10, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 11, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 18, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 20, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 27, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 29, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 36, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 37, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 45, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 46, :], axis=0)
    ) / 12
    ...
    training_accuracy_baseline_standardDeviation = (
        numpy.std(trainingKPIs[:, :, 1, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 2, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 10, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 11, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 18, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 20, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 27, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 29, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 36, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 37, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 45, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 46, :], axis=0)
    ) / 12
    ...
    testing_accuracy_baseline_standardDeviation = (
        numpy.std(testingKPIs[:, :, 1, :], axis=0)
        + numpy.std(testingKPIs[:, :, 2, :], axis=0)
        + numpy.std(testingKPIs[:, :, 10, :], axis=0)
        + numpy.std(testingKPIs[:, :, 11, :], axis=0)
        + numpy.std(testingKPIs[:, :, 18, :], axis=0)
        + numpy.std(testingKPIs[:, :, 20, :], axis=0)
        + numpy.std(testingKPIs[:, :, 27, :], axis=0)
        + numpy.std(testingKPIs[:, :, 29, :], axis=0)
        + numpy.std(testingKPIs[:, :, 36, :], axis=0)
        + numpy.std(testingKPIs[:, :, 37, :], axis=0)
        + numpy.std(testingKPIs[:, :, 45, :], axis=0)
        + numpy.std(testingKPIs[:, :, 46, :], axis=0)
    ) / 12
    ...
    training_loss_baseline_mu = (
        ...
        + numpy.mean(trainingKPIs[:, :, 16, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 21, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 25, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 30, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 34, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 39, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 43, :], axis=0)
    ...
    testing_loss_baseline_mu = (
        ...
        + numpy.mean(testingKPIs[:, :, 16, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 21, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 25, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 30, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 34, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 39, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 43, :], axis=0)
    ...
    training_accuracy_baseline_standardDeviation = (
        ...
        + numpy.std(trainingKPIs[:, :, 16, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 21, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 25, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 30, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 34, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 39, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 43, :], axis=0)
    ...
    testing_accuracy_baseline_standardDeviation = (
        ...
        + numpy.std(testingKPIs[:, :, 16, :], axis=0)
        + numpy.std(testingKPIs[:, :, 21, :], axis=0)
        + numpy.std(testingKPIs[:, :, 25, :], axis=0)
        + numpy.std(testingKPIs[:, :, 30, :], axis=0)
        + numpy.std(testingKPIs[:, :, 34, :], axis=0)
        + numpy.std(testingKPIs[:, :, 39, :], axis=0)
        + numpy.std(testingKPIs[:, :, 43, :], axis=0)
    ...
    training_loss_baseline_mu = (
        ...
        + numpy.mean(trainingKPIs[:, :, 17, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 22, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 26, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 31, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 35, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 40, :], axis=0)
        + numpy.mean(trainingKPIs[:, :, 44, :], axis=0)
    ...
    testing_loss_baseline_mu = (
        ...
        + numpy.mean(testingKPIs[:, :, 17, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 22, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 26, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 31, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 35, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 40, :], axis=0)
        + numpy.mean(testingKPIs[:, :, 44, :], axis=0)
    ...
    training_accuracy_baseline_standardDeviation = (
        ...
        + numpy.std(trainingKPIs[:, :, 17, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 22, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 26, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 31, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 35, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 40, :], axis=0)
        + numpy.std(trainingKPIs[:, :, 44, :], axis=0)
    ...
    testing_accuracy_baseline_standardDeviation = (
        ...
        + numpy.std(testingKPIs[:, :, 17, :], axis=0)
        + numpy.std(testingKPIs[:, :, 22, :], axis=0)
        + numpy.std(testingKPIs[:, :, 26, :], axis=0)
        + numpy.std(testingKPIs[:, :, 31, :], axis=0)
        + numpy.std(testingKPIs[:, :, 35, :], axis=0)
        + numpy.std(testingKPIs[:, :, 40, :], axis=0)
        + numpy.std(testingKPIs[:, :, 44, :], axis=0)
